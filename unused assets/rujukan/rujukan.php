<?php
// Ambil data dari URL, kalau kosong kasih default 'umum'
$poli_dipilih = $_GET['poli'] ?? 'umum';

// Mapping judul atau warna biar otomatis berubah
$daftar_judul = [
    'umum'   => 'Poli Umum',
    'anak'   => 'Poli Anak',
    'lansia' => 'Poli Lansia',
...
$judul_halaman = $daftar_judul[$poli_dipilih] ?? 'Layanan Kesehatan';
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Form Pendaftaran Poli Umum</title>
</head>
<body class="bg-[#f0f4ff] min-h-screen font-sans p-6 overflow-x-hidden relative">
    ...
    <header class="mb-10 pl-2">
        <h1 class="text-3xl font-bold">Form Rujukan <?php echo $judul_halaman; ?></h1>
        
        <p class="text-lg font-bold text-gray-800">
            Layanan Kesehatan <?php echo str_replace('Poli ', '', $judul_halaman); ?>
        </p>
    </header>
        ...
        <div class="bg-white/80 backdrop-blur-sm rounded-[40px] shadow-2xl p-8 border border-white">
            ...
            <form action="#" method="POST" class="space-y-8">
                ...
                <div class="bg-[#f5f8ff] rounded-3xl p-6 shadow-inner border border-blue-50">
                    ...
                    <textarea rows="4" placeholder="Contoh: Pergelangan tangan saya sering kesemutan karena terlalu lama mengoding..." 
