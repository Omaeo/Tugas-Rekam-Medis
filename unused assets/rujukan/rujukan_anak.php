...
<head>
    ...
    <title>Form Pendaftaran Poli Anak</title>
</head>
<body class="bg-[#f0f4ff] min-h-screen font-sans p-6 overflow-x-hidden relative">
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <header class="mb-10 pl-2">
            <h1 class="text-4xl font-black text-[#1e4b8a] tracking-tight border-b-4 border-[#1e4b8a] w-fit mb-1">POLI Anak</h1>
            <p class="text-lg font-bold text-gray-800">Layanan Kesehatan Anak</p>
        </header>
