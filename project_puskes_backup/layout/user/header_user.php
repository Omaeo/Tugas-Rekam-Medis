        ...
        <div class="nav-right">
            ...
            <div class="avatar">
                ...
                <div class="profile-dropdown">
                    ...
                    <hr>
                    <a href="account/logout.php" class="logout"><i class="fas fa-sign-out-alt"></i> Keluar</a>
                </div>
            </div>
        </div>
    </nav>
...
<script>
    ...
    navLinks.forEach(link => {
        link.addEventListener('click', function(e) {
            ...
            // Jika klik link internal (#jadwal), jangan biarkan script lama menghapus 'active'
            if (href.startsWith('#')) {
    ...
    window.addEventListener('scroll', function() {
        ...
        // Gunakan 10px saja supaya transisinya lebih cepat terasa
